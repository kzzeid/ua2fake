...
int main(int argc, char *argv[]) {
    ...
    memset(UAstr, 'M', sizeof_buf);
	memcpy(str, "Mozilla/5.0 (Linux; Android X; xiaomi 7 Build/QKQ1.190925.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/69.0", 129);
